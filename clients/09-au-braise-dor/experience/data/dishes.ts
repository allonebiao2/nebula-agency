...
> = {
  ...
  "Sauce arachide":      { id: "arachide", kicker: "La pâte d'arachide", tint: "#7A4A22", wash: "#F3EAE0" },
  "Sauce graine":        { id: "graine",   kicker: "La graine de palme", tint: "#9E5F20", wash: "#F5E9DC", img: "/plats/sc-graine.webp" },
  "Sauce tomate":        { id: "tomate",   kicker: "Tomate fraîche",     tint: "#A3301F", wash: "#F7E7E2" },
  "Sauce tête de mouton":{ id: "gbata",    kicker: "Le gbata",           tint: "#6B4230", wash: "#F1E8E1" },
  "Sauce pieds de bœuf": { id: "blokoto",  kicker: "Le blokoto",         tint: "#5C4433", wash: "#F0EAE3" },
  "Sauce Yassa":         { id: "yassa",    kicker: "Oignon et citron",   tint: "#8A6A12", wash: "#F6F0DC" },
  "Sauce Yassa au poulet":{ id: "yassapoulet", kicker: "Le yassa au poulet", tint: "#8F5A16", wash: "#F6ECDC" },
