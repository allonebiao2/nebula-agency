...
pièce d'identité n° **[type et numéro]**,
téléphone WhatsApp **[numéro]**, email **[email]**,
numéro Mobile Money de règlement **[numéro]**,
...
présente et fait souscrire les services de NEBULA auprès de clients, en contrepartie
de commissions.

Le Partenaire agit en qualité d'**apporteur d'affaires indépendant**.

---

## ARTICLE 2 · INDÉPENDANCE DES PARTIES

**2.1** Le Partenaire n'est ni salarié, ni agent, ni mandataire de NEBULA. Il ne se trouve
dans aucun lien de subordination. Le présent contrat ne peut en aucun cas être requalifié
en contrat de travail.

**2.2** Le Partenaire organise librement son temps, ses méthodes et son lieu de travail.
NEBULA ne lui impose ni horaires, ni présence, ni quota.

**2.3** Le Partenaire fait son affaire personnelle de ses obligations fiscales et sociales
au titre des sommes qu'il perçoit.

**2.4** Le Partenaire ne peut en aucun cas engager NEBULA, signer en son nom, ou prendre
un engagement quelconque au nom de NEBULA au-delà de ce que prévoit le présent contrat.

---

## ARTICLE 3 · MISSION DU PARTENAIRE

**3.1 Ce que fait le Partenaire.** Rechercher des prospects, leur présenter les offres de
NEBULA, recueillir leur besoin, obtenir leur accord, et transmettre à NEBULA les éléments
nécessaires à la réalisation.

**3.2 Ce que fait NEBULA.** Concevoir, réaliser, livrer, héberger, sécuriser, et assurer
les corrections après livraison.

**3.3 Le Partenaire ne réalise aucune prestation technique** et n'a aucune compétence
technique à fournir.

**3.4 Après la livraison**, le Partenaire est le premier interlocuteur du client. NEBULA
...
**4.1** Les offres et tarifs en vigueur au jour de la signature sont :

| Service | Prix |
|---|---|
| Catalogue Digital + QR Code (jusqu'à 20 produits) | 50 000 F |
| Lot de 10 produits supplémentaires | 15 000 F |
| Vitrine Digitale + QR Code (une page) | 150 000 F |
| Page supplémentaire | 30 000 F |
| QR Code Google Review | 30 000 F |
...
## ARTICLE 5 · ENCAISSEMENT

**5.1** **Le client règle exclusivement NEBULA.** Le Partenaire ne perçoit **aucune somme**
du client, sous aucune forme, y compris en espèces et y compris à titre de service rendu.

**5.2** Le Partenaire ne communique jamais lui-même de coordonnées bancaires : NEBULA les
transmet directement au client.

**5.3** Le non-respect des articles 5.1 et 5.2 constitue une **faute grave** entraînant la
résiliation immédiate du contrat, sans préjudice de toute action en recouvrement.

**5.4 Modalités.** Catalogue et QR Google Review : paiement intégral. Vitrine et Outil
Digital : 70 % au démarrage, 30 % à la mise en ligne. Un virement bancaire n'est réputé
payé qu'une fois constaté sur le compte de NEBULA.

---

## ARTICLE 6 · COMMISSIONS

**6.1 Commission directe.** Le Partenaire perçoit un pourcentage du montant hors abonnement
...
**6.2 Commission sur abonnement.** Le Partenaire perçoit **20 % de chaque abonnement
encaissé** auprès d'un client qu'il a apporté, souscription initiale et renouvellements
compris, soit **4 000 F par client et par semestre**.

Cette commission est **acquise à vie**, tant que le client concerné reste abonné, **y compris
après la fin du présent contrat**. Elle ne compte pas dans le décompte des ventes de
...
**6.5 Paiement.** Le Partenaire réclame ses commissions depuis son espace personnel.
**NEBULA règle sous 24 à 72 heures** par Mobile Money, sur le numéro indiqué en tête
du présent contrat.
...
**7.1** Un prospect appartient au **premier Partenaire qui l'enregistre** dans son espace
personnel. L'enregistrement fait foi.

**7.2** Cette attribution vaut **60 jours**. Passé ce délai sans vente conclue, le prospect
...
1. Représenter NEBULA avec honnêteté et correction ;
2. **Ne jamais promettre un délai inférieur à 5 à 7 jours** ouvrés après brief complet et paiement ;
3. **Ne jamais garantir un positionnement sur Google** ;
4. **Ne jamais annoncer un prix ou un délai** sur un Outil Digital sur mesure ;
5. **Ne jamais promettre la conformité fiscale** d'une facture normalisée, celle-ci s'étudiant
   au cas par cas ;
6. Ne jamais promettre une fonctionnalité non prévue sans accord écrit de NEBULA ;
7. Ne jamais modifier ni promettre de modifier un numéro WhatsApp figurant sur une réalisation ;
8. Ne percevoir aucune somme d'un client (article 5) ;
9. Ne jamais dénigrer un concurrent ;
...
## ARTICLE 9 · EXCLUSIVITÉ DE MÉTIER

**9.1** Pendant la durée du contrat, le Partenaire s'interdit de présenter, promouvoir ou
vendre, pour le compte d'une autre agence ou pour son propre compte, des sites internet,
catalogues digitaux, applications ou logiciels de gestion.

**9.2** Le Partenaire conserve le droit d'exercer toute autre activité professionnelle,
commerciale ou salariée, dans un domaine différent.

---

## ARTICLE 10 · CONFIDENTIALITÉ

**10.1** Le Partenaire s'interdit de divulguer les informations non publiques dont il a
connaissance : documents commerciaux internes, méthodes, tarifs non publiés, fichiers
clients, données recueillies lors d'un diagnostic.

**10.2** Les documents remis (guides de vente, socle commercial, fiches de diagnostic)
restent la **propriété de NEBULA** et doivent être restitués ou détruits à la fin du contrat.

**10.3** Cette obligation survit **3 ans** à la fin du contrat.

---

## ARTICLE 11 · NON-SOLLICITATION APRÈS LA FIN DU CONTRAT

**11.1** Pendant **24 mois** suivant la fin du contrat, le Partenaire s'interdit de démarcher,
...
**11.2** Cette obligation a pour contrepartie directe le **maintien à vie des commissions
sur abonnement** prévu à l'article 6.2, dont le Partenaire continue de bénéficier après son
départ. Elle porte sur la seule clientèle de NEBULA, constituée à ses frais, et ne fait pas
obstacle à ce que le Partenaire exerce librement toute autre activité auprès de toute autre
personne.

---

## ARTICLE 12 · DURÉE, INACTIVITÉ ET FIN DU CONTRAT

**12.1 Durée.** Le contrat est conclu pour une **durée indéterminée** à compter de sa
signature.

**12.2 Résiliation.** Chaque partie peut y mettre fin à tout moment, par écrit
(WhatsApp ou email suffisent), avec un **préavis de 15 jours**. En cas de faute grave
(articles 5.3 et 8), la résiliation est **immédiate et sans préavis**.
...
- les **Conditions Générales du Programme Partenaires** acceptées en ligne ;
- le **Socle Commercial NEBULA** en vigueur, qui détaille offres, prix et règles.

En cas de contradiction, **le présent contrat prévaut**.

---

## ARTICLE 16 · RÈGLEMENT DES DIFFÉRENDS

Les parties s'engagent à rechercher une solution amiable. À défaut, le litige relève des
**tribunaux compétents de Cotonou**, la loi béninoise étant applicable.
...
## ANNEXE · CE QUE LE PARTENAIRE DOIT RETENIR
...
**Si je pars**, mes commissions sur abonnement continuent, à vie, tant que mes clients
restent abonnés. C'est ce que j'ai construit, ça reste à moi. En contrepartie je m'interdis
