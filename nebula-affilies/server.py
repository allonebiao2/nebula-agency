...
def agency_brain() -> str:
    ...
    return (
        ...
        "DE 55 000 FCFA et jusqu'à 300 000 FCFA maximum selon la complexité. Le devis final est confirmé après "
        "un court échange. Exemples de secteurs : industrie/HSE, commerce, immobilier, santé.\n\n"
