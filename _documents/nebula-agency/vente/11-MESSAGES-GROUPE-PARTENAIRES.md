# MESSAGES POUR LE GROUPE WHATSAPP DES PARTENAIRES
## Ce qu'on envoie aux 3 partenaires actifs, et ce qu'on n'envoie pas

> Document de procédure, à l'usage de Mongazi. Créé le 2026-08-01.
> Règles de diffusion : `07-MISE-EN-LIGNE.md` §1 · Certification : `00-SOCLE-COMMERCIAL.md` §5.7
...
⚠️ **Ne pas noyer ça dans le message 1.** Un partenaire qui annonce l'ancien prix crée un
...
Si vous avez annoncé 15 000 F à un prospect ces derniers jours,
...
Vous connaissez quelqu'un qui sait parler aux commerçants ?
Envoyez-lui cette affiche.

⚠️ Ce n'est pas de la cooptation automatique : il y a un entretien,
...
```
Dernière chose, et c'est la plus importante.

On met en place un point de 30 minutes chaque semaine.
[jour] à [heure]. Ce n'est pas optionnel.

Pas pour vous surveiller : pour que vous ne soyez pas seuls
les semaines où ça ne rentre pas. C'est ce moment-là que
la plupart des vendeurs abandonnent, partout dans le monde.
On ne va pas faire pareil.

Dites-moi si [jour] [heure] vous convient.
```

> **Ce message-là n'est pas décoratif.** Le socle §11 le dit : sans prime de première vente
...
Voici la charte d'engagement du programme. Lis-la, signe-la à la main,
et renvoie-moi la photo ici.

C'est la dernière étape avant que tes accès soient créés.
Rien à payer, jamais.
```

---

## 3. L'ordre et le rythme
...
*NEBULA Agency · Cotonou, Bénin · Document interne.*
