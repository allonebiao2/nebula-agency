...
| 10 | Hillary | **HILLARY M. STYL** — maison de couture (monogramme H.M.S) · prêt-à-porter par tailles **+ sur-mesure** · magenta `#E6007E` + noir, Archivo + Manrope | **Vitrine + moteur de commande livrée 2026-07-31** (`clients/10-hillary-m-styl/vitrine.html`, 120 Ko, logo base64 WebP déclaré 1 seule fois) : catalogue à 2 onglets, fiche produit modale, **tunnel en 4 étapes** (taille OU 8 mesures femme/homme → retrait atelier ou expédition avec **frais par pays** → délai normal/express → coordonnées) + récapitulatif chiffré en direct → WhatsApp structuré · accueil personnalisé (moment de la journée + prénom mémorisé) · QC : 0 débordement 390/768/1440, 0 erreur JS, cibles ≥44px, 0 image externe · ⚠️ **7 informations à confirmer avant mise en ligne** (n° WhatsApp, frais d'expédition, délais, vraies pièces, photos, adresse atelier) — toutes marquées dans un bloc « ZONE À COMPLÉTER » en haut du script | ⚠️ à confirmer |
