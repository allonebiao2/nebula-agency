...
- **Sauce poisson frais** — à la sauce tomate + crin-crin au choix — **3 000**
- _Accompagnements_ : Agbéli, pâte noire, riz, pâte de manioc, pâte de maïs, piron, Akassa

## Sauces Européennes
- **Sauce Béchamel** — champignon blanc, haricot vert, oignon vert (steak ou filet de poisson ou poulet à l'ail haché) — **5 000**
- **Sauce Crème** — filet de poisson à la crème aux champignons — **5 000**
- _Accompagnements_ : riz, pommes sautées, pommes vapeur, frites, attiéké

## Salades
- **Salade verte** — laitue, tomate, oignon, olive noire — **1 000**
- **Salade composée** — laitue, concombre, carotte, oignon, pomme de terre, petit pois, betterave, maïs doux, viande hachée, œuf, pain, vinaigrette — **3 000**
- **Salade JOQ** — laitue, pomme de terre, oignon, œuf, carotte râpée, jambon, viande hachée, crevette, maïs doux, cornichon, pain, vinaigrette, petit pois, avocat — **4 000**
...
- Café serré — **500**
- Café chaud/froid au lait écrémé — **1 000**
- Lipton citron — **500**
- Cappuccino — **1 500**
- Café au lait (Peak) — **1 000**

**Plateaux**
- Plateau — café/thé/lait sucré, beurre ou confiture, pain ou croissant, omelette, jus ananas/orange — **3 500**
- Plateau Mignon JOQ — chocolat chaud, beurre, croissant, œuf à la coque, jus de fruit, yaourt — **4 000**
...
- Au poulet — **2 500**
- **Chawarma JOQ** (poulet + viande) — **3 000**
...
## Spécial Cocktail
**Sans alcool**
- **Babariba** — papaye, banane, pomme, lait, sirop de fraise — **2 500**
- **Paparazi** — jus de citron, banane, orange, sirop de framboise — **2 500**
...
## Hamburger
- **Simple** (+ Coca) — **2 500**
- **Cheese** — cheese, viande, frites (+ Coca) — **3 000**
- **Double** — frites (+ Coca) — **3 500**
- **King** — burger, œuf (+ Coca) — **2 500**
