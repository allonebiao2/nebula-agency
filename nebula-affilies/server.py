...
def agency_brain() -> str:
    ...
    return (
        ...
        "multi-utilisateurs, multi-sites...). Mise en service À PARTIR DE 200 000 FCFA, plus un abonnement tous "
        "les 6 mois. Un configurateur de devis est disponible sur le site (bouton « Obtenir mon devis en ligne » "
        "dans la section Services) : le visiteur choisit ce qu'il veut et obtient une estimation immédiate. "
