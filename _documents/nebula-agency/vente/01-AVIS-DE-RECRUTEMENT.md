...
> 2. La version WhatsApp et statut
...
>
> Version 1.0 · 2026-07-30 · Adossé au `00-SOCLE-COMMERCIAL.md`

---

## Note de méthode (à lire avant de publier)
...
2. **On donne les chiffres réels.** La plupart des annonces de commission au Bénin disent
   ...
   **45 000 F sur une vitrine, 250 000 F sur un mois à 6 ventes.** Les vrais vendeurs calculent.
...
NEBULA Agency est un studio béninois de solutions digitales basé à Cotonou. Nous ne faisons pas
des sites génériques : nous concevons l'outil digital dont chaque métier a besoin.

Ce n'est pas un projet sur papier. **9 clients sont déjà livrés et en ligne**, entre autres :
...
Trois offres, du plus simple au plus ambitieux.
...
Votre pourcentage monte avec votre nombre de ventes dans le mois.
...
- **Votre carte de visite professionnelle**, générée avec votre photo, votre nom et votre QR code,
  prête à imprimer ou à envoyer en statut WhatsApp.
- **Trois guides de vente complets**, un par service : arguments, questions à poser, démonstration,
  objections et réponses mot pour mot.
- **Une formation au démarrage**, puis un accompagnement en binôme sur vos premiers dossiers.
- **NOVA**, l'assistante IA de NEBULA, disponible à toute heure pour répondre à vos questions.
- **Un classement d'équipe et une messagerie** : vous n'êtes jamais seul sur le terrain.

**Vous ne livrez rien.** Vous vendez, vous récupérez les informations du client, et NEBULA fait
tout le reste. Vous n'avez besoin d'aucune compétence technique.
...
- Vous vous exprimez bien **en français**, et parler **fon, yoruba ou goun** est un vrai avantage
  sur le terrain.
...
- **L'expérience en vente est un plus, pas une condition.** Nous formons. La motivation et la
  régularité ne se forment pas.

**Un vrai bonus :** si vous avez déjà un réseau (association, marché, groupe de commerçants,
communauté religieuse, ancienne clientèle), dites-le. C'est votre premier terrain de chasse.
...
## 2. VERSION WHATSAPP ET STATUT (à diffuser en masse)
...
Vous gagnez 30 % à 50 % sur chaque vente.
Une vitrine vendue = 45 000 F pour vous, 75 000 F au palier OR.
...
Ou écrivez PARTENAIRE au +229 96 74 07 32
```
...
Vous savez parler aux gens ? On vous paie 30 à 50 % sur chaque vente.
...
```
   ...
   Vous touchez 30 % à 50 % par vente.

        Une vente = 15 000 F à 150 000 F
...
**Où l'afficher :** cybercafés, écoles de commerce et centres de formation, agences de transfert
d'argent, salles de sport, églises et paroisses, boutiques de téléphonie, campus.
...
Un client demande le prix à 22h, personne ne répond, le client va ailleurs.
...
Vous présentez nos offres, nous produisons tout, vous touchez 30 % à 50 % par vente.
...
Candidature : https://partenaires.nebula-agency.online/devenir
```

---

## 5. GRILLE DE SÉLECTION (notée sur 20)

À remplir pendant ou juste après l'entretien. **Ne recrutez jamais à l'instinct : notez.**

| Critère | Ce qu'on évalue | Points |
|---|---|---|
| **Aisance relationnelle** | Est-ce qu'il parle avec aisance à un inconnu, sans réciter ? | /5 |
| **Régularité prouvée** | A-t-il déjà tenu une activité dans la durée (école, commerce, sport, association) ? | /4 |
| **Réseau existant** | Connaît-il déjà des commerçants ? Combien peut-il en citer nommément ? | /4 |
| **Compréhension de l'offre** | A-t-il ouvert les sites du portfolio avant l'entretien ? Sait-il quoi en dire ? | /3 |
| **Rapport à l'argent et à l'effort** | Comprend-il que la commission se gagne, ou attend-il un fixe déguisé ? | /2 |
...
- **8 à 11** → En réserve, rappelé si une place se libère
- **Moins de 8** → Refusé, avec un message poli et une porte laissée ouverte

**Éliminatoire immédiat, quel que soit le score :**
...
> puis je vous explique exactement comment on travaille et combien on gagne. À la fin, vous
> me direz si ça vous intéresse toujours. Il n'y a pas de mauvaise réponse, mais j'ai besoin
> que vous soyez franc. D'accord ? »

---

**1. Parlez-moi de ce que vous faites en ce moment.**
...
*Bon signe :* il raconte un cas réel, il dit ce que l'autre a répondu.
*Mauvais signe :* des généralités (« je suis très persuasif de nature »).

**3. Avez-vous ouvert un des sites que nous avons livrés ? Lequel, et qu'en avez-vous pensé ?**
*C'est LA question qui trie.* Un candidat sérieux a regardé avant de venir.
*Bon signe :* il en cite un, il donne un détail précis.
*Mauvais signe :* il ne l'a pas fait. Il ne le fera pas non plus avec un client.

**4. Citez-moi 5 commerçants de Cotonou que vous connaissez personnellement.**
*On écoute :* la vitesse et la précision de la réponse. Noms, activités, quartiers.
*Bon signe :* il en cite 5 en moins d'une minute, il sait ce qu'ils vendent.
*Mauvais signe :* il hésite, il reste vague. Son terrain de chasse est vide.

**5. Un commerçant vous dit : « Un site, ça sert à rien, j'ai déjà Facebook. » Vous répondez quoi ?**
*On n'attend pas la bonne réponse, on regarde le réflexe.*
*Bon signe :* il pose une question en retour au lieu d'argumenter tout de suite.
*Mauvais signe :* il se braque, il insiste, ou il abandonne.

**6. Vous voyez 10 commerçants dans la semaine et aucun n'achète. Vous faites quoi le lundi suivant ?**
*C'est la question de la résilience. La plus importante avec la n°4.*
*Bon signe :* il parle de recommencer en changeant quelque chose, il demande de l'aide.
*Mauvais signe :* il parle d'arrêter, ou il accuse le produit et le prix.

**7. Combien de temps par semaine pouvez-vous réellement y consacrer ? Quels jours, quelles heures ?**
*On écoute :* la précision. Le vague annonce l'abandon.
*Bon signe :* des créneaux nommés (« les matins du mardi au samedi »).
*Mauvais signe :* « quand j'ai le temps », « tout le temps ».

**8. Vous êtes payé uniquement à la commission. Le premier mois, vous pourriez ne rien gagner. Ça vous va ?**
*Il faut poser la question franchement et regarder le visage.*
*Bon signe :* il dit oui et explique comment il tient financièrement en attendant.
*Mauvais signe :* il négocie un fixe, une avance, ou un « dédommagement transport ».

**9. Qu'est-ce que vous attendez de NEBULA pour réussir ?**
*On écoute :* est-ce qu'il demande des outils et de la formation, ou des garanties ?
*Bon signe :* « des supports, une formation, qu'on livre bien mes clients ».
*Mauvais signe :* « qu'on me donne des clients ».

**10. Vous avez une question pour moi ?**
*Un vendeur pose toujours des questions. Toujours.*
...
## 7. MESSAGE DE BIENVENUE (partenaire retenu)

> Le back-office génère déjà un kit d'accès en un clic (espace, code, PIN, lien personnel) avec
...
Vos 3 premières choses à faire, dans cet ordre :

1. Connectez-vous et faites le tour guidé (10 minutes). Ajoutez votre photo :
   les partenaires avec photo vendent mieux, c'est mesuré.
2. Lisez le GUIDE CATALOGUE dans l'onglet Documentation. C'est votre première arme,
   c'est l'offre la plus facile à vendre, et vous pouvez la vendre dès aujourd'hui.
3. Faites la liste de 20 commerçants que vous connaissez déjà. Pas 100, pas 5. Vingt.
   Envoyez-la moi, on la travaille ensemble.

Votre lien personnel est votre outil le plus important : tout ce qui passe par lui vous est
...
filleuls atteignent 3 dans le mois, 50 % dès que vous en faites 4 à vous seul. Aucune
commission sur vos filleuls : leurs ventes font monter votre palier, c'est tout.
...
## 8. PLAN DE DIFFUSION (14 jours)

| Jour | Action | Canal |
|---|---|---|
| J1 | Publication de l'annonce complète | Page Facebook NEBULA + LinkedIn |
| J1 | Statut WhatsApp + envoi à tous les contacts personnels | WhatsApp |
...
*NEBULA Agency · Cotonou, Bénin · Document interne, à ne pas diffuser tel quel : seules les
sections 1 à 4 sont publiques.*
