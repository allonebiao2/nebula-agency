...
export default function Questionnaire({ aller }) {
  ...
  const peutAvancer = () => {
    ...
    if (etape === 7) return nomOk && emailOk && telOk && momoOk
    return false
  }
            ...
            {etape === 7 && (
              <div>
                ...
                <p className="mt-3 max-w-[38rem] text-[0.98rem] leading-relaxed text-sourd">
                  Tout est obligatoire, et rien n'est de trop : le carnet part par email, les
                  échanges passent par WhatsApp, et c'est votre numéro Mobile Money qui permet de
                  reconnaître votre paiement parmi ceux du jour.
                </p>
                ...
                <div className="mt-7 space-y-5">
                  ...
                  <p className="text-[0.85rem] leading-relaxed text-sourd">
                    Écrivez-les comme ils apparaissent sur votre compte Mobile Money : c'est ce nom
                    qui s'affiche à la réception du paiement.
                  </p>
                ...
                <div className="mt-8 rounded-2xl border border-trait bg-creme p-5">
                  ...
                  <p className="mt-4 text-[0.88rem] leading-relaxed text-sourd">
                    Aucun paiement ne se fait sur ce site, et rien de ce que vous écrivez ici ne
                    part sur un serveur : tout passe par la conversation WhatsApp. Votre commande
                    reste valable 24 heures, ensuite les fiches retournent au stock.
                  </p>
                </div>
