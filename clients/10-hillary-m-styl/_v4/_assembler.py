...
{"@context":"https://schema.org","@graph":[
 ...
 {"@type":"FAQPage","mainEntity":[
  ...
  {"@type":"Question","name":"Comment saurai-je où en est ma commande ?","acceptedAnswer":{"@type":"Answer","text":"Vous recevez un message dès que votre commande est validée. Puis, quand votre tenue est prête, l'atelier vous envoie un message ou vous appelle directement. C'est pour cela que votre numéro de téléphone est demandé au moment de la commande."}},
